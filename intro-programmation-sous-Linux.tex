...
\begin{frame}
  ...
  il y a $13! = 6 227 020 800$ (plus de six milliards)
...
\begin{frame}
  ...
  En langage \href{https://ocaml.org/}{Ocaml}:

  \begin{alltt}
    \textcolor{green}{(*factorielle en Ocaml, récursivement*)}

    \textcolor{red}{\textbf{let rec}} fact n = \\
    \hspace{1cm} \textcolor{red}{\textbf{if}} n > 1  \textcolor{red}{\textbf{then}} n * fact (n - 1) \\
    \hspace{1cm} \textcolor{red}{\textbf{else}} 1 \\
     \textcolor{blue}{\textbf{;;}} 
  \end{alltt}

  itérativement avec recursion terminale
  
  \begin{alltt}
    \textcolor{green}{(*factorielle en Ocaml, iterativement*)}

    \textcolor{red}{\textbf{let}} fact n = \\
    \hspace{1cm} \textcolor{red}{\textbf{let rec}} factloop n p = \\
    \hspace{1.5cm} \textcolor{red}{\textbf{if}} n > 0  \\
    \hspace{1.5cm} \textcolor{red}{\textbf{then}} factloop (n-1) (n * p) \\
    \hspace{1.5cm} \textcolor{red}{\textbf{else}} p \\    
    \hspace{1cm} \textcolor{red}{\textbf{in}} factloop n 1\\
     \textcolor{blue}{\textbf{;;}} 
  \end{alltt}
