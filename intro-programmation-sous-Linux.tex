% fichier  introprog-montpellibre-2020/intro-programmation-sous-Linux.tex
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item préférer ou permettre la \textbf{lecture des données
      d'entrée sur l'entrée standard} {\relsize{-1}{(souvent notée
        \texttt{-} ou \texttt{/dev/stdin} dans les arguments du
        programme)}}, et l'\textbf{écriture des résultats de sortie
      sur la sortie standard} {\relsize{-1}{(souvent passée comme
        \texttt{-} ou \texttt{/dev/stdout} en argument de programme)}}
...
\begin{frame}
  ...
  \texttt{\textbf{)}}. \relsize{-1}{ Les noms permis en Scheme sont
    bizarres: \texttt{\textit{letrec-syntax}} est un seul nom (un
    quasi- mot-clé introduisant temporairement vos propres nouveaux
    mots-clés).}

  \vspace{0.3cm}
  
\href{https://www.gnu.org/software/guile/}{GNU \textsc{Guile}} est une implémentation de Scheme défini dans
...
50 pages). Voir \href{http://starynkevitch.net/Basile/guile-tutorial-1.html}{ce tutoriel d'initiation}
  ...
  {\large \textcolor{red}{\textbf{À lire absoluement}} le fameux et fabuleux \href{https://mitpress.mit.edu/sites/default/files/sicp/index.html}{\relsize{+3}{SICP}}}
  (\textit{``structure and interpretation of computer programs''}) \textbf{en ligne} {\relsize{-1.5}{(au MIT, centaines de pages)}}
...
\begin{frame}
  ...
  pour le traitement des arguments du programme,

%  et la
%  \href{http://caml.inria.fr/pub/docs/manual-ocaml/libref/Stdlib.html#VALint_of_string}{fonction
...
%  entier.
  ...
  \href{https://fr.wikipedia.org/wiki/Programmation_fonctionnelle}{programmation
    fonctionnelle} pour la lisibilité du code.
