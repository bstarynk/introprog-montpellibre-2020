...
\begin{frame}
  ...
  \href{https://www.gnu.org/software/libc/manual/html_node/Parsing-Program-Arguments.html}{parsing
    program arguments} pour fournir le traitement convenable d' un \texttt{--help} et
  \texttt{--version}. Sans ça, dans un fichier \texttt{intendance.c} contenant :

%  \lgrindfile{cod-intendance.tex}
