...
\begin{frame}
  ...
  \item un propriétaire ou utilisateur (désigné par un numéro)

  \item un groupe (désigné par un numéro)

  \item des droits d'accès pour le propriétaire, le groupe, les autres

  \end{itemize}

  L'utilisateur 0 est spécial: \textbf{\textcolor{red}{root}} et ``peut tout faire''
...
\begin{frame}
  ...
  Voir \href{https://man7.org/linux/man-pages/man7/inode.7.html}{inode(7)} pour les détails, et \href{https://man7.org/linux/man-pages/man2/stat.2.html}{stat(2)} pour les interroger.
  ...
  \item taille du fichier (en octets) et taille occupée en blocs
    ...
    \item droit d'accès (\texttt{rwx}) lecture, écriture, execution pour l'utilisateur
    \item droit d'accès (\texttt{rwx}) lecture, écriture, execution pour le groupe
    \item droit d'accès (\texttt{rwx}) lecture, écriture, execution pour les autres
  \end{itemize}
