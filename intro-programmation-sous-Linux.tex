...
\begin{frame}
  ...
  \includegraphics[width=0.9\textwidth]{powerpc-branch-instr}
\end{frame}

%\begin{frame}
%  \frametitle{Couches logicielles}
%  \framesubtitle{Exemple: Architecture PowerPC : entrées-sorties}
%  \includegraphics[width=0.9\textwidth]{powerpc-io-instr}
%\end{frame}

\begin{frame}
  \frametitle{Couches logicielles}
  \framesubtitle{Exemple: Architecture PowerPC : appel système}
  \includegraphics[width=0.9\textwidth]{powerpc-syscall-instr}
\end{frame}
